...
-   **🏢 Khodaldham Trading:** Accountant & Supervisor (Feb 2022 - Nov 2024)
-   **🏭 Bufab India Pvt. Ltd.:** QC Dept. (May 2020 - Jan 2022)
-   **🖌️ Office Beacon:** Web Graphics Designer (Nov 2019 - Mar 2020)
-   **📞 Concentrix:** SEO Content Development (Jun 2019 - Sep 2019)
-   **🏫 KV ONGC, Baroda:** Back Office Assistant (Dec 2018 - Jun 2019)
...
If you've cloned this repository and want to run it locally (if you have a Node.js server setup):

1.  Clone the repository: `git clone https://github.com/sagarchauhansk/sagarchauhansk.github.io.git`
2.  Navigate to the directory: `cd sagarchauhansk.github.io`
...
This site is hosted on GitHub Pages. For more information, visit [https://pages.github.com/](https://pages.github.com/).

## 📧 Contact

-   GitHub: [https://github.com/sagarchauhansk](https://github.com/sagarchauhansk)
